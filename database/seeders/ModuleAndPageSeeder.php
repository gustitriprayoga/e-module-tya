...
class ModuleAndPageSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // 2. Data Konten per Halaman (Judul & Narasi Materi)
        $pagesContent = [
            ...
            // Halaman 11-20 (Dibuat ringkas untuk contoh, silakan kembangkan teksnya)
        ...
        foreach ($pagesContent as $index => $data) {
            ...
            $page = Page::updateOrCreate(
                ['module_id' => $module->id, 'order_number' => $pageNum],
                [
                    'title' => $data['title'],
                    'is_published' => true
                ]
            ...
            // 5. Insert Quiz Block pada halaman tertentu (Misal setiap 4 halaman)
            if ($pageNum % 4 == 0) {
                Block::create([
                    'page_id' => $page->id,
                    'type' => 'quiz',
        ...
        $this->command->info('Seed: 25 Detailed Pages created for Reading II.');
    }
}
